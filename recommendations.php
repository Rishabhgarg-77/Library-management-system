            ...
            <?php else: ?>
                <?php foreach ($recs as $b): ?>
                    <div class="book-result">
                        <p><strong><a href="/Librarymanagement_system/book.php?id=<?php echo (int)$b['id']; ?>"><?php echo htmlspecialchars($b['title']); ?></a></strong> by <?php echo htmlspecialchars($b['author']); ?></p>
